...
# And?
If plans don't change. We go. Patience. Or y'know, Cheat Engine's always there if you love staring at hex addresses instead. And for those who've done it, unpro tip, cancel the build when the two required .dll are built, none of the other files are needed. Only one needs the lib prefix removed, or else you'll just crash the engine.
